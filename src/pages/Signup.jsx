export default function Signup() {
    return (
        <div id="signup" className="">
            <div className="p-5">
                <h5 className="font-bold">Create account</h5>
            ...
            <div className="p-5">
                <div className="flex flex-col space-y-2">
                    ...
                    <input className="h-12 rounded-md pl-5 text-sm w-full bg-gray-100" type="text" name="" placeholder="Type your name here" />
                </div>
                <div className="flex flex-col space-y-2">
                    <span></span>
                ...
                <div className="flex flex-col space-y-2">
                    ...
                    <input className="h-12 rounded-md pl-5 text-sm w-full bg-gray-100" type="email" name="" placeholder="Type your email here" />
                </div>
                <div className="flex flex-col space-y-2">
                    <span></span>
            ...
            <div className="bottom-5 absolute px-5 text-white w-full">
                <button className="rounded-md h-14 w-full bg-yellow-500 font-bold">Register</button>
            </div>
        </div>
    )
}
